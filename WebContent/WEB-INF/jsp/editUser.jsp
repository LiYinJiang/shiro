	...
	<div class="workingroom">
		...
		<div class="addOrEdit"> 
			<form action="updateUser" method="post">
				...
				<br> 密碼: <input type="password" name="password" value=""
					placeholder="留空就表示不修改密码"><br> <br> 配置角色:<br>
				<div
					...
					<c:forEach items="${roles }" var="role">
						...
						<input type="checkbox" ${hasRole? "checked='checked'":"" }
							name="roleIds" value="${role.id}">${role.name }<br>
