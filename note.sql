...
INSERT INTO `permission` VALUES (3,'editCode','编辑代码','/editCode');
INSERT INTO `permission` VALUES (4,'updateCode','修改代码','/updateCode');
INSERT INTO `permission` VALUES (5,'listCode','查看代码','/listCode');
INSERT INTO `permission` VALUES (6,'addFeature','增加功能','/addFeature');
INSERT INTO `permission` VALUES (7,'deleteFeature','删除功能','/deleteFeature');
INSERT INTO `permission` VALUES (8,'editFeature','编辑功能','/editFeature');
INSERT INTO `permission` VALUES (9,'updateFeature','修改功能','/updateFeature');
INSERT INTO `permission` VALUES (10,'listFeature','查看功能','/listFeature');
INSERT INTO `role` VALUES (1,'admin','超级管理员');
INSERT INTO `role` VALUES (2,'codeManager','代码管理员');
INSERT INTO `role` VALUES (3,'featureManager','功能管理员');
